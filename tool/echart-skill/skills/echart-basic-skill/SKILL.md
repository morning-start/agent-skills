...
- [echart-finance-skill](../echart-finance-skill/SKILL.md) - 金融图表（K线图、雷达图）
- [echart-multi-skill](../echart-multi-skill/SKILL.md) - 多图组合（grid叠加）
- [echart-advanced-skill](../echart-advanced-skill/SKILL.md) - 高级特性（dataset数据处理）

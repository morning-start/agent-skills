...
- [echart-finance-skill](../echart-finance-skill/SKILL.md) - 金融图（K线+成交量组合）
- [echart-geo-skill](../echart-geo-skill/SKILL.md) - 地理图（地图+散点+航线组合）
- [echart-advanced-skill](../echart-advanced-skill/SKILL.md) - 高级特性（DataZoom联动）

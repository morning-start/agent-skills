...
| 子技能 | 覆盖范围 | 触发关键词 |
|--------|---------|-----------|
| [rust-ownership](rust-ownership/SKILL.md) | 所有权、借用、生命周期 | "借用检查"、"move"、"lifetime" |
| [rust-concurrency](rust-concurrency/SKILL.md) | 多线程、Sync/Send、原子操作 | "线程安全"、"竞态条件"、"Mutex" |
| [rust-error-handling](rust-error-handling/SKILL.md) | 错误类型设计、thiserror/anyhow | "Result"、"错误传播"、"AppError" |
| [rust-async](rust-async/SKILL.md) | async/await、Pin/Future、流 | "async"、"tokio"、"Stream" |
| [rust-cli-project](rust-cli-project/SKILL.md) | CLI 参数解析、TUI、发布 | "命令行"、"clap"、"终端应用" |
| [rust-performance](rust-performance/SKILL.md) | 基准测试、 profiling、优化 | "性能"、"benchmark"、"criterion" |
| [rust-testing-doc](rust-testing-doc/SKILL.md) | 测试策略、mock、属性测试 | "测试"、"mockall"、"proptest" |
| [rust-smart-pointers](rust-smart-pointers/SKILL.md) | Rc/Arc/Weak/Cow/Cell | "智能指针"、"引用计数" |
| [rust-collections](rust-collections/SKILL.md) | Vec/HashMap/BTreeSet 选择 | "集合"、"数据结构选择" |
| [rust-generics](rust-generics/SKILL.md) | 泛型、trait bound、关联类型 | "泛型"、"trait"、"monomorphization" |
| [rust-type-driven](rust-type-driven/SKILL.md) | 类型状态编程、newtype 模式 | "类型安全"、"type-state"、"phantom" |
| [rust-domain-design](rust-domain-design/SKILL.md) | DDD 领域建模 | "领域驱动"、"实体"、"值对象" |
| [rust-domain-error](rust-domain-error/SKILL.md) | 领域错误建模 | "领域错误"、"业务规则验证" |
| [rust-resource-management](rust-resource-management/SKILL.md) | RAII、Drop、守卫模式 | "资源管理"、"RAII"、"cleanup" |
| [rust-zero-cost](rust-zero-cost/SKILL.md) | 零成本抽象原理 | "零成本"、"monomorphization"、"inline" |
| [rust-mental-model](rust-mental-model/SKILL.md) | Rust 心智模型 | "心智模型"、"栈vs堆"、"所有权直觉" |
| [rust-mutability](rust-mutability/SKILL.md) | 可变性模式、Interior Mutability | "可变性"、"Cell"、"RefCell" |
| [rust-lifecycle](rust-lifecycle/SKILL.md) | 生命周期高级用法 | "生命周期省略"、"HRTB"、"covariance" |
| [rust-iterators](rust-iterators/SKILL.md) | 迭代器适配器、消费器 | "iterator"、"map/filter/collect" |
| [rust-struct-enum](rust-struct-enum/SKILL.md) | 结构体/枚举设计模式 | "enum dispatch"、"newtype pattern" |
| [rust-core](rust-core/SKILL.md) | 核心trait (From/TryInto/Deref) | "From"、"TryFrom"、"Operator overload" |
| [rust-cargo](rust-cargo/SKILL.md) | Cargo 高级用法、workspace | "workspace"、"feature flag"、"profile" |
| [rust-ecosystem](rust-ecosystem/SKILL.md) | 生态系统导航、crate 选择 | "用什么crate"、"crates.io" |
| [rust-web](rust-web/SKILL.md) | Web 开发完整指南 | "HTTP API"、"REST"、"WebSocket" |
| [rust-cloud-native](rust-cloud-native/SKILL.md) | 云原生/K8s/微服务 | "云原生"、"kubernetes"、"gRPC" |
| [rust-fintech](rust-fintech/SKILL.md) | 金融科技/量化交易 | "金融"、"交易系统"、"高精度" |
| [rust-embedded](rust-embedded/SKILL.md) | 嵌入式/no_std 开发 | "MCU"、"STM32"、"embassy" |
| [rust-iot](rust-iot/SKILL.md) | IoT 设备开发 | "IoT"、"传感器"、"MQTT" |
| [rust-ml](rust-ml/SKILL.md) | 机器学习/AI | "ML"、"神经网络"、"推理" |
| [rust-anti-pattern](rust-anti-pattern/SKILL.md) | 反模式大全 | "反模式"、"常见错误"、"pitfall" |
## 参考文档

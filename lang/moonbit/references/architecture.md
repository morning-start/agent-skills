...
flowchart TD
    ...
    Q -->|语法基础| C1[moonbit-core]
    Q -->|数据结构| C2[moonbit-data-structures]
    Q -->|模式匹配| C3[moonbit-pattern-matching]
    Q -->|构建/工具| C4[moonbit-toolchain]
    Q -->|包管理| C5[moonbit-packages]
    Q -->|WASM 开发| C6[moonbit-wasm]
...
|---------|---------|
| "如何声明变量" | moonbit-core |
| "模式匹配怎么用" | moonbit-pattern-matching |
| "如何构建项目" | moonbit-toolchain |
| "怎么发布包" | moonbit-packages |
| "编译到 WASM" | moonbit-wasm |
| "数组/Map 用法" | moonbit-data-structures |
| "函数式编程" | moonbit-functions |
| "泛型和 Trait" | moonbit-generics |
| "错误处理" | moonbit-error-handling |

## 四维分类

根据 skill-factory 分类体系，moonbits 属于 **Type 4 (重+厚)**：
